...
public class GoToThePaymentsPageTest {
    ...
    public void goToThePaymentsPage() {
        ...
        // Подтверждаю условия
        WebElement undertakeConditions =  driver.findElement(By.xpath("//*[@id=\"i_undertake_conditions\"]"));
        jse.executeScript("arguments[0].click()", undertakeConditions);
        // Подтвердить
        ...
        wait2.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"aspnetForm\"]/div[3]/div/div[1]/h2")));
