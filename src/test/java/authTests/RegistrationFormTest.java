...
//        assertEquals(driver.findElement(By.xpath("//input[@id=\'signup_nickname\']")).getAttribute("class"), "err_message");
    ...
    public void testEnteredLoginAlreadyInUse() {
        ...
        wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[@id=\"signup_frm\"]/table/tbody/tr[3]/td/div"), "The entered login ('lena123') is already in use. Please, choose another login."));
        String errMsg = driver.findElement(By.xpath("//*[@id=\"signup_frm\"]/table/tbody/tr[3]/td/div")).getText();
